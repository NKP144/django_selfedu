...
SECRET_KEY = 'django-insecure-j3scc)o%y@bspjppysmbxirgwq=p_iskmo_ja0zoo4*7-4vb1w'
...
STATIC_ROOT = []  # Список полнительный (нестандартных) путей к статическим файлам,
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')    # В папке media текущей папки рабочего проекта
MEDIA_URL = '/media/'
